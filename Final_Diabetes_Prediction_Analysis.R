...
#ST563 Final Project
#Group: J
#Program Authors: Chung-Pang Hsu; Kerem Ziya Akdemir; Yan Liu
#Date:11-26-2021
#####################################################
#Import library
library(caret)
...
diabetes <- read.csv("C:/Users/bonhs/OneDrive/Documents/NCSU/NCSU ST563/R/diabetes.csv", header = TRUE)
